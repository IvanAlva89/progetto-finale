...
const Home = () => {
    ...
    <div className="gap-3 flex justify-between p-6 rounded ">
        <div className="flex-1 bg-gray-200 p-4 rounded flex flex-col items-center">
            <img src="../assets/prodotti/fast-delivery.png" alt="" className="w-6 h-6"/>
            <h3>Fast Delivery</h3>
            <p>Quick and reliable delivery service</p>
        </div>
        <div className="flex-1 bg-gray-200 p-4 rounded flex flex-col items-center">
            <img src="../assets/prodotti/exclusive.png" alt="" className="w-6 h-6"/>
            <h3>Exclusive Offers</h3>
            <p>Special deals and promotions</p>
        </div>
        <div className="flex-1 bg-gray-200 p-4 rounded flex flex-col items-center">
            <img src="../assets/prodotti/rebuild.png" alt="" className="w-6 h-6"/>
            <h3>Rebuild</h3>
            <p>Top-notch rebuilding services</p>
        </div>
        <div className="flex-1 bg-gray-200 p-4 rounded flex flex-col items-center">
            <img src="../assets/prodotti/bot.png" alt="" className="w-6 h-6"/>
            <h3>Support Bot</h3>
