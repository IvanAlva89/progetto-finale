            ...
            <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
                ...
                <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                    <form className="space-y-6" onSubmit={handleRegister}>
                        <div>
                            <label htmlFor="role" className="block text-sm font-medium leading-6 text-gray-900">Registrati come</label>
                        ...
                        </div>
                        {
                            role == "seller" && (
                                <div>
                                    <label htmlFor="name" className="block text-sm font-medium leading-6 text-gray-900">Nome Azienda</label>
                                    <div className="mt-2">
                        ...
                        <div>
                            <label htmlFor="first_name" className="block text-sm font-medium leading-6 text-gray-900">Nome</label>
                            <div className="mt-2">
                        ...
                        <div>
                            <label htmlFor="last_name" className="block text-sm font-medium leading-6 text-gray-900">Cognome</label>
                            <div className="mt-2">
                        ...
                        <div>
                            <button type="submit" className="flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Registrati</button>
                        </div>
                    </form>
                    <p className="mt-10 text-center text-sm text-gray-500 flex gap-2 items-center">
                        Hai già un account?
                        <Link to={`/login${searchParams.get("r") ? `?r=${searchParams.get("r")}` : ""}`} className="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">Accedi</Link>
                    </p>
                </div>
            </div>
        </>
